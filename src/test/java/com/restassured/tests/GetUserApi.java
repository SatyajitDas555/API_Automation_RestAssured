...
public class GetUserApi extends BaseClass{
	...
	public void getSpecificUserDetails() {
		...
		//Validating status code = 200
		Assert.assertEquals(response.statusCode(), 200, "Reponse code is not matched");
		ExtentTestManager.getTest().log(LogStatus.PASS, "Response Status Code 200");
	...
	@Test
	public void validateInvalidStatusCode_GetUsersDetails() {
		...
		//Validating status code = 200
		Assert.assertNotEquals(response.statusCode(), 200, "Status code is 200 expected is 400");
		ExtentTestManager.getTest().log(LogStatus.PASS, "Response Status Code 400");
	...
	@Test
	public void validateInvalidBody_GetUsersDetails() {
		...
		int sizeOfDataObjects = ReusableMethods.getCountOfDataObjects(response.getBody().jsonPath().getList("data"));
		//Validate the data contains 6 data objects
		Assert.assertEquals(sizeOfDataObjects, 5 , "Data Objects is < or > 5");
		ExtentTestManager.getTest().log(LogStatus.PASS, "Response Body contains 5 Data Object");
...
// _ve Scenario validation for specific User Details

@Test
public void Negative_getSpecificUserDetails() {
	...
	Assert.assertEquals(jsonPath.get("data.email"), "george123.bluth@reqres.in", "Email response is incorrect");
	ExtentTestManager.getTest().log(LogStatus.PASS, "Response Body contains  \"george.bluth@reqres.in\" as \"Email\"");
